    ...
    <main className="orders-page page-shell" style={{ margin: '0 6%' }}>
      <section className="orders-hero" style={{ margin: '24px 0 0' }}>
        <div className="orders-hero-copy" style={{ textAlign: 'center' }}>
          ...
          <div className="orders-hero-actions" style={{ justifyContent: 'center' }}>
        ...
        <div className="orders-hero-summary" style={{ alignContent: 'center', textAlign: 'center' }}>
      ...
      <section className="orders-card" style={{ margin: '40px 0' }}>
        <div className="orders-list">
          {REVIEWS.map((review) => (
            <article key={review.name} className="order-card" style={{ cursor: 'default' }}>
              <div className="order-card-preview" style={{ textAlign: 'center' }}>
                <div className="order-card-header" style={{ justifyContent: 'center', marginBottom: '16px' }}>
                  <div>
